@extends('master')
@section('title','Career at Japan')
@section('career','active')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="head_title mt-3 mb-3 text-center">Visa</h2>
                <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.
                    ...
                    Entry requirements may vary between English speaking country and non-English speaking countries and institute to institutes. We advise please book an appointment to know your entry requirements.</p>
                <h2 class="mb-3 text-center">Legal Issue</h2>
